...
If there is not something that binds truth, justice, mercy and sacrifice, then none of these concepts have any meaning or true value. They are merely disjointed, random concepts that have no connection to each other. But if there is something that binds them, then they must have a common source, and that source is God.
