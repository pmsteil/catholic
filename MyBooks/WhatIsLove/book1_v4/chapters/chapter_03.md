...
But the evolutionary story begins in the middle. Natural selection creates nothing—it can only select among things that already exist, so it cannot explain why anything exists to be selected. Why is there a universe at all rather than nothing? Why is that universe alive rather than sterile? Why does every living thing in it fight to stay alive? And why is reality so arranged that creatures flourish by bonding, cooperating, giving themselves away—so that, billions of years on, a mother's sacrifice works and a betrayal wounds? The materialist receives every one of these as a free gift and starts counting from there. He can explain how love spread through a world already built for it. He cannot explain who built the world that way—or why a universe of blind, indifferent matter should be ordered, from its first moment, in favor of love.

Science describes mechanisms brilliantly—how behaviors develop, how neural pathways function, how chemicals affect receptors. But it is not equipped to answer "why" questions—questions of existence, purpose, and ultimate grounding.
