...
And this dignity we possess as image-bearers is not merely spiritual — it is embodied. **We are not souls using bodies as tools; we are embodied persons.** Pope Saint John Paul II taught that *"the body, and it alone, is capable of making visible what is invisible: the spiritual and the divine."* This means justice must honor not just the soul but the body itself — what it is, what it reveals, and what it is for.
