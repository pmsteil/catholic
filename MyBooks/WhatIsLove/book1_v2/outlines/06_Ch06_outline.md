...
4. *   **Problem of Evil:**
    *  CT/Intersectionality/Wokeness offers very little in the way of a solution to the problem of oppression that it desires to address. It offers no accountabilty for the evil that exists in the human heart, and it fails to recognize that the solution to oppression is not simply a redistribution of power, but a transformation of the heart. It does not address the need for **true justice** and **mercy**, which are essential for healing and reconciliation. It often leads to more division and resentment rather than true understanding and healing.
